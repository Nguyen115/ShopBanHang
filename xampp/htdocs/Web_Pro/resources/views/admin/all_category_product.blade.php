          ...
          <tr>
            ...
            <td><span class="text-ellipsis">
                ...
                if($cate_pro->category_status==0)
                 {?>
                <a href="{{URL::to('/active_category_product/'.$cate_pro->category_id)}}"><span class="fa fa-thumbs-up"></span></a>
                <?php
            }else{
                ?>
                <a href="{{URL::to('/unactive_category_product/'.$cate_pro->category_id)}}"><span class="fa fa-thumbs-down"></span></a>
              <?php
            }
              ?>
