...
<html>
	...
	<!-- Flexslider  -->
	<link rel="stylesheet" href="{{asset('frontend/flexslider.css')}}">
	<!-- Owl Carousel  -->
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-xs-2">
					<div id="fh5co-logo"><a href=<?= url('homepage'); ?>>Shop.</a></div>
				</div>
                            ...
                            <a href=<?= url('shop'); ?>>Shop</a>
                                ...
                                <li class="has-dropdown">
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="single.html">ABC</a></li>
                                        @endforeach
                                    </ul>
                                </li>
                            </li>
						...
						<div class="owl-carousel owl-carousel-fullwidth">
							<div class="item">
								<div class="testimony-slide active text-center">
									<figure>
										<img src="frontend/images/person1.jpg" alt="user">
									</figure>
							...
							<div class="item">
								<div class="testimony-slide active text-center">
									<figure>
										<img src="frontend/images/person2.jpg" alt="user">
									</figure>
