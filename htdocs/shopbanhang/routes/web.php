...
Route::get('/homepage','App\Http\Controllers\HomeController@homepage');
...
Route::get('/active__product/{product_id}','App\Http\Controllers\ProductController@active_product');
