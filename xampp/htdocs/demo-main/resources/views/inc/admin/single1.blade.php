                        ...
                        <div class="owl-carousel owl-carousel-fullwidth product-carousel">
                            <div class="item">
                                <div class="active text-center">
                                    <figure>
                                        <img src="asset/images/product-single-1.jpg" alt="user">
                                    </figure>
                                </div>
                            </div>
                            <div class="item">
                                <div class="active text-center">
                                    <figure>
                                        <img src="asset/images/product-single-2.jpg" alt="user">
                                    </figure>
                                </div>
                            </div>
                            <div class="item">
                                <div class="active text-center">
                                    <figure>
                                        <img src="asset/images/product-single-3.jpg" alt="user">
                                    </figure>
                                </div>
                            </div>
                            <div class="item">
                                <div class="active text-center">
                                    <figure>
                                        <img src="asset/images/product-single-4.jpg" alt="user">
                                    </figure>
                                </div>
                            </div>
                            <div class="item">
                                <div class="active text-center">
                                    <figure>
                                        <img src="asset/images/product-single-5.jpg" alt="user">
                                    </figure>
                                </div>
                            </div>
                        </div>
