...
<<head>
    ...
    <link rel="stylesheet" href="{{asset('asset/vendor/fonts/material-design-iconic-font/css/materialdesignicons.min.css')}}">
						...
						<ul class="navbar-nav flex-column">
									...
									<ul class="nav flex-column">
										<li class="nav-item">
											...
											<div id="submenu-1-2" class="collapse submenu" style="">
												<ul class="nav flex-column">
													<li class="nav-item">
														<a class="nav-link" href="{{asset('asset/pages/index.html')}}">E Commerce Dashboard</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" href="{{asset('asset/pages/ecommerce-product.html')}}">Product List</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" href="{{asset('asset/pages/ecommerce-product-single.html')}}">Product Single</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" href="{{asset('asset/pages/ecommerce-product-checkout.html')}}">Product Checkout</a>
													</li>
												</ul>
											</div>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="{{asset('asset/pages/dashboard-finance.html')}}">Finance</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="{{asset('asset/pages/dashboard-sales.html')}}">Sales</a>
										</li>
										<li class="nav-item">
											...
											<div id="submenu-1-1" class="collapse submenu" style="">
												<ul class="nav flex-column">
													<li class="nav-item">
														<a class="nav-link" href="{{asset('asset/pages/dashboard-influencer.html')}}">Influencer</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" href="{{asset('asset/pages/influencer-finder.html')}}">Influencer Finder</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" href="{{asset('asset/pages/influencer-profile.html')}}">Influencer Profile</a>
													</li>
												</ul>
											</div>
										</li>
							...
							<li class="nav-item">
								...
								<div id="submenu-2" class="collapse submenu" style="">
									<ul class="nav flex-column">
										<li class="nav-item">
											<a class="nav-link" href="{{asset('asset/pages/cards.html')}}">Cards <span class="badge badge-secondary">New</span></a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="{{asset('pages/general.html')}}">General</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="{{asset('asset/pages/carousel.html')}}">Carousel</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="{{asset('asset/pages/listgroup.html')}}">List Group</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="{{asset('asset/pages/typography.html')}}">Typography</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="{{asset('asset/pages/accordions.html')}}">Accordions</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="{{asset('asset/pages/tabs.html')}}">Tabs</a>
										</li>
									</ul>
								</div>
							</li>
							<li class="nav-item">
								...
								<div id="submenu-3" class="collapse submenu" style="">
									<ul class="nav flex-column">
										<li class="nav-item">
											<a class="nav-link" href="{{asset('pages/chart-c3.html')}}">C3 Charts</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="{{asset('asset/pages/chart-chartist.html')}}">Chartist Charts</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="{{asset('asset/pages/chart-charts.html')}}">Chart</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="{{asset('asset/pages/chart-morris.html')}}">Morris</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="{{asset('asset/pages/chart-sparkline.html')}}">Sparkline</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="{{asset('asset/pages/chart-gauge.html')}}">Guage</a>
										</li>
									</ul>
								</div>
							</li>
							<li class="nav-item ">
								...
								<div id="submenu-4" class="collapse submenu" style="">
									<ul class="nav flex-column">
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/form-elements.html">Form Elements</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/form-validation.html">Parsely Validations</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/multiselect.html">Multiselect</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/datepicker.html">Date Picker</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/bootstrap-select.html">Bootstrap Select</a>
										</li>
									</ul>
								</div>
							</li>
							<li class="nav-item">
								...
								<div id="submenu-5" class="collapse submenu" style="">
									<ul class="nav flex-column">
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/general-table.html">General Tables</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/data-tables.html">Data Tables</a>
										</li>
									</ul>
								</div>
							</li>
							...
							<li class="nav-item">
								...
								<div id="submenu-6" class="collapse submenu" style="">
									<ul class="nav flex-column">
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/blank-page.html">Blank Page</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/blank-page-header.html">Blank Page Header</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/login.html">Login</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/404-page.html">404 page</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/sign-up.html">Sign up Page</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/forgot-password.html">Forgot Password</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/pricing.html">Pricing Tables</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/timeline.html">Timeline</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/calendar.html">Calendar</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/sortable-nestable-lists.html">Sortable/Nestable List</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/widgets.html">Widgets</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/media-object.html">Media Objects</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/cropper-image.html">Cropper</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="asset/pages/color-picker.html">Color Picker</a>
										</li>
									</ul>
								</div>
							</li>
